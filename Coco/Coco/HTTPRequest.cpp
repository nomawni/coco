...
void HTTPRequest::execute() {
	...
	// Prepare the resolving request

	boost::asio::ip::tcp::resolver::query resolver_query(m_host,
...
void HTTPRequest::on_host_name_resolved(const boost::system::error_code& ec,
...
void HTTPRequest::on_connection_established(const boost::system::error_code& ec,
	boost::asio::ip::tcp::resolver::iterator iterator) {
