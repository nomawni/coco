...
SyncSSLClient::SyncSSLClient(const std::string& raw_ip_address,
...
std::string SyncSSLClient::emulate_long_computation_op(
...
bool SyncSSLClient::on_peer_verify(bool preverified,
